...
for i in range(0, len(predicted_labels)):
    predicted_labels[i, 16:19] = predicted_labels[i, 16:19]*predicted_labels[i, 1]
    predicted_labels[i,4:6] = predicted_labels[i,4:6]*predicted_labels[i,2]
    predicted_labels[i, 26:29] = predicted_labels[i, 26:29]*predicted_labels[i, 4]
    predicted_labels[i, 6:8] = predicted_labels[i, 6:8]*predicted_labels[i, 5]
    predicted_labels[i, 8:10] = predicted_labels[i, 8:10]*(predicted_labels[i, 6]+predicted_labels[i, 7])
    predicted_labels[i, 29:32] = predicted_labels[i, 29:32]*predicted_labels[i, 8]
    predicted_labels[i, 32:38] = predicted_labels[i, 32:38]*(predicted_labels[i, 29]+predicted_labels[i, 30]+predicted_labels[i, 31])
    predicted_labels[i, 10:14] = predicted_labels[i, 10:14]*(predicted_labels[i, 9]+predicted_labels[i, 32]+predicted_labels[i, 33]+predicted_labels[i, 34]+predicted_labels[i, 35]+predicted_labels[i, 36]+predicted_labels[i, 37])
    predicted_labels[i, 19:26] = predicted_labels[i, 19:26]*predicted_labels[i, 14]
...
result_dataframe.to_csv('result_11Models.csv', index=False)
